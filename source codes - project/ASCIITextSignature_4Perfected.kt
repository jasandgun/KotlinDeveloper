...
fun generate (name: String, stat: String) {//Function to print upper and lower borders and call other relevant functions
    val romanFont = "C:/fonts/roman.txt"
    val rfFile = File(romanFont).readLines(Charsets.US_ASCII)
    val mediumFont = "C:/fonts/medium.txt"
    val mfFile = File(mediumFont).readLines(Charsets.US_ASCII)
...
fun statCount (stat: String, mfFile: List<String>): Int { //Function to count how many spaces are there in the status
...
fun nameCount (name: String, rfFile: List<String>): Int { //Function to count how many spaces are there in the name
